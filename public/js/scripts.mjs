...
function setInitialPrompt(input) {
    ...
    const defaultPrompt = `I'm a medical student, and together, we’re going to create a diagnosis simulation. You'll provide me with information about ${input}-related diseases, and I'll try to guess the condition. Give me information step by step, without revealing everything at once. When I request tests or lab results, respond with only new, unique information relevant to my question, avoiding any repeated details you've already provided. Each time I ask a question, give one new piece of information, then wait for my next question. At the end, I'll make a diagnosis, and you’ll confirm if it's correct or not and provide a final report. Don’t make any guesses yourself; just answer my questions step by step so I can deduce the disease. Start with the patient’s age, gender, and primary complaints. At each step, respond clearly to my question only with concise, distinct answers, without including previously stated information.`;
